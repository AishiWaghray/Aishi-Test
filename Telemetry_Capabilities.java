...
@Autonomous(name = "Telemetry Capabilites", group = "Exercises")
public class Telemetry_Capabilities extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            //free form is apponded at the end. I can place some warnings (easy for me to understnad) in here.
            addFreeFormLog(sampleText);
            telemetry.update(); //this pushes the data to the Motorola Phone
